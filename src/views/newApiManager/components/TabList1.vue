  ...
  <div class="sdm-bg">
    <div class="sdm-bg-sty sdm-bg-data">
      ...
      <el-table v-loading="loading" :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="name" :label="$t('app_1014')" />
        <!-- <el-table-column prop="env" label="运行环境" /> -->
        <el-table-column prop="path" :label="$t('app_1009')" />
        <el-table-column prop="method" :label="$t('method')" />
        <el-table-column prop="authentication" :label="$t('app_1019')" />

        <!-- <el-table-column prop="project" label="所属项目" /> -->
        <!-- <el-table-column prop="group" label="分组" /> -->

        <el-table-column :label="$t('operation')" width="260">
          <template slot-scope="scope">
            <el-button
              type="text"
              size="small"
              @click="handleEdit(scope.row, scope, 1)"
              >{{ $t("edit") }}</el-button
            >
            ...
            <el-button
              type="text"
              size="small"
              @click="handleEdit(scope.row, scope, 2)"
            ...
            <el-button
              type="text"
              size="small"
              @click="handleEdit(scope.row, scope, 3)"
              >上架</el-button
            >
            <el-button
              type="text"
              size="small"
              @click="handleEdit(scope.row, scope, 4)"
              >在线调试</el-button
            >
          </template>
        </el-table-column>
