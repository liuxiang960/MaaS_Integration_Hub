  ...
  <div>
    <el-form ref="form" :model="sizeForm" label-width="120px">
      ...
      <el-form-item :label="$t('app_1017')">
        <el-input v-model="sizeForm.apiPath" :placeholder="$t('app_1018')" />
      ...
      <el-form-item :label="$t('app_1019')">
        <el-select v-model="sizeForm.authentication">
          <el-option label="NoAuth" value="NoAuth" />
          <el-option label="BasicAuth" value="BasicAuth" />
          <el-option label="OAuth2.0" value="OAuth2.0" />
          <el-option label="HMAC-1" value="HMAC-1" />
          <el-option label="HMAC-256" value="HMAC-256" />
        </el-select>
      </el-form-item>
